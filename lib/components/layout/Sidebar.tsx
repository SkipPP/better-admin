...
import { Building, Command, Plus, User as UserIcon, Users } from "lucide-react";

import { NavUser } from "~/lib/components/layout/NavUser";
import { NavMain } from "~/lib/components/layout/NavMain";
import { OrganizationSwitcher } from "~/lib/components/layout/OrganizationSwitcher";
    ...
    <Sidebar className="z-50" variant="inset" collapsible="icon" {...props}>
      <SidebarHeader>
        {userRole === "admin" ? (
          ...
          <OrganizationSwitcher userData={userData} />
        )}
      </SidebarHeader>
