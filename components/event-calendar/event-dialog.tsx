...
import type { Meeting } from "~/server/types";

// Extend the Meeting type with UI-specific properties
...
interface EventDialogProps {
  event: ExtendedMeeting | null;
  isOpen: boolean;
  onClose: () => void;
  onSave: (event: ExtendedMeeting) => void;
...
export function EventDialog({
  ...
  const handleSave = useCallback(() => {
    ...
    const updatedEvent: ExtendedMeeting = {
      id: event?.id || "",
      title: eventTitle,
      description: description || null,
      start,
      end,
      date: start, // Use start date as the date field
      allDay,
      location,
      color,
  ...
  // Memoize resetForm to prevent recreation
        ...
        >
          <div className="*:not-first:mt-1.5">
            ...
            <Input
              ...
              aria-required="true"
              aria-invalid={!title}
              aria-describedby={!title ? "title-error" : undefined}
            />
            {!title && (
