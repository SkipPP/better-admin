...
export function WeekView({
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="bg-background/80 border-border/70 sticky -top-4 z-30 grid grid-cols-8 border-b backdrop-blur-md">
        <div className="text-muted-foreground/70 py-2 text-center text-sm">
          <span className="max-[479px]:sr-only">
            {format(new Date(), "O", { locale: fr })}
          </span>
        </div>
        {days.map((day) => (
          <div
          ...
          >
            <span className="sm:hidden" aria-hidden="true">
              {format(day, "E", { locale: fr })[0]} {format(day, "d", { locale: fr })}
            </span>
