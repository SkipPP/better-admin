...
import { OrganizationMember, FullOrganization } from "~/server/types";
import {
...
import { MoreHorizontal, Pencil, UserPlus, Trash, Plus, Mail } from "lucide-react";
    ...
    return (
        ...
        onOpenChange={(open) => {
          if (!open) {
            if (dialogStates.edit) {
              ...
              closeDialog("addUser");
            } else if (dialogStates.inviteUser) {
              closeDialog("inviteUser");
      ...
      >
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-[220px]">
            ...
            <DropdownMenuItem onClick={() => openDialog("addTeam")}>
              <Plus /> <span>Ajouter une équipe</span>
            </DropdownMenuItem>

            <DropdownMenuSeparator />

            <DropdownMenuItem onClick={() => openDialog("inviteUser")}>
              <Mail /> <span>Inviter un utilisateur</span>
            </DropdownMenuItem>
        ...
        <DialogContent>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Input
                    ...
                    name="slug"
                    type="text"
                    defaultValue={organization.slug ?? undefined}
                    className="shadow-none"
                  />
                </div>
          ...
          {organization && dialogStates.inviteUser && (
            <form
              className="grid gap-y-6"
              onSubmit={async (event) => {
                event.preventDefault();
                ...
                try {
                  await inviteOrganizationMember({ data: formData })
                    .then(() => {
                      closeDialog("inviteUser");
            ...
            >
              <DialogHeader>
                ...
                <DialogDescription>Invitez un membre à l'organisation.</DialogDescription>
              </DialogHeader>
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <Input id="email" name="email" type="email" className="shadow-none" />
                </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <Select name="userId">
                    <SelectTrigger id="userId" className="w-full shadow-none">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Select name="teamId" defaultValue={organization.teams?.[0]?.id}>
                    <SelectTrigger id="teamId" className="w-full shadow-none">
                      <SelectValue placeholder="Sélectionner une équipe" />
                    </SelectTrigger>

                    <SelectContent>
                      <SelectItem value="null">Aucune équipe</SelectItem>
          ...
          {organization && dialogStates.editTeam && (
            <form
              className="grid gap-y-6"
              onSubmit={async (event) => {
                event.preventDefault();
